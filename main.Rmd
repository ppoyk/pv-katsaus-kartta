...
# Näytetään ka vain yhdellä rivillä per asema (helpottamaan ihmislukijaa)
# Ilmoitetaan myös ka:ssa käytettyjen putkien lkm
koonti_as_ka[["ka_N"]] <- NA # Alustetaan sarake keskiarvon putkien lkm:lle
for (a in unique(koonti_as_ka$asema_tunnus)) {
  koonti_as_ka[koonti_as_ka$asema_tunnus == a, "ka_N"] <-
    nrow(koonti_as_ka[koonti_as_ka$asema_tunnus == a,])
  koonti_as_ka[koonti_as_ka$asema_tunnus == a,
